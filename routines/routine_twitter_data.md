...
python3 scripts/check_freshness.py data/twitter/latest/tweets_for_routine_data.json --max-age-hours 6
```
...
Read the data file (the repo is already cloned from STEP 0): `data/twitter/latest/tweets_for_routine_data.json`
