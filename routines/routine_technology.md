...
Do NOT render or PUSH by hand beyond these commands — `publish_technology.py
...
- LOCAL ONLY: `git add processed/technology/ && git commit -m 'technology insights: progress (local)'`
- NEVER push these. NEVER run `publish_technology.py` for them.
